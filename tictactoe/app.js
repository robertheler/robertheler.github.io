...
//state.playerOne.name = prompt(`Let's paly Tic-Tac-Toe! Player one (X), please enter your name:`, 'X');
//state.playerOne.name = prompt(`Let's paly Tic-Tac-Toe! Player two (O), please enter your name:`, 'O');
